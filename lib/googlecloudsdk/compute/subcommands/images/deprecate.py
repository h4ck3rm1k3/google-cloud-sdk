...
class DeprecateImages(base_classes.BaseAsyncMutator):
  """Deprecate Google Compute Engine images."""

  @staticmethod
  def Args(parser):
    base_classes.BaseAsyncMutator.Args(parser)
  ...
  def CreateRequests(self, args):
    ...
    if args.replacement:
      replacement_uri = self.context['uri-builder'].Build(
          'global', 'images', args.replacement)
    else:
